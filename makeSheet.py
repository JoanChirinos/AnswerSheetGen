...
def go():
    ...
    for q in range(1, qnum + 1):
        ...
        if (q % 3 == 0 or q == qnum):
            toWrite += '</div>\n'
    toWrite += '\n\n\n<div class="lg-space"></div>\n\n\n<div class="row text-center"><div class="col"><input type="text" placeholder="Enter correct answers here as a long string of numbers Ex. 1332142313" name="correctAnswers"></div></div><div class="row text-center">\n<div class="col"><input class="btn btn-success btn-lg btn-block" type="submit" value="Submit"></div></div><div class="lg-space"></div>'
